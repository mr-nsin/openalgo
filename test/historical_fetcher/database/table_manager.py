...
class TimeFrameCode(IntEnum):
    ...
    @classmethod
    def from_timeframe(cls, timeframe: TimeFrame) -> 'TimeFrameCode':
        """Convert TimeFrame enum to numeric code"""
        mapping = {
    ...
    @classmethod
    def to_timeframe_string(cls, code: int) -> str:
        """Convert numeric code back to timeframe string"""
        mapping = {
            1: '1m',
            3: '3m',
            5: '5m',
