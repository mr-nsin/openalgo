...
from blueprints.optionchain import optionchain_bp  # Import the optionchain blueprint
...
def create_app():
    ...
    app.register_blueprint(optionchain_bp)  # Register Option Chain blueprint
