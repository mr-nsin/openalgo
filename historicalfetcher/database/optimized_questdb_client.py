    ...
    async def _insert_enhanced_equity_data(
        ...
        for result in indicator_results:
            ...
            data_tuple = (
                ...
                # Ichimoku Cloud
                result.indicators.get('ichimoku_tenkan_sen'),
                result.indicators.get('ichimoku_kijun_sen'),
                result.indicators.get('ichimoku_senkou_span_a'),
                result.indicators.get('ichimoku_senkou_span_b'),
                result.indicators.get('ichimoku_chikou_span'),
                result.indicators.get('ichimoku_cloud_top'),
                result.indicators.get('ichimoku_cloud_bottom'),
                result.indicators.get('ichimoku_cloud_color'),
                result.indicators.get('ichimoku_signal'),
                
                # Aroon Indicator
                result.indicators.get('aroon_up'),
                ...
                result.indicators.get('ad_line_signal'),
                result.indicators.get('cmf_20'),
                result.indicators.get('cmf_signal'),
        ...
        insert_query = f"""
            INSERT INTO {table_name} (
                ...
                volume_sma_20, vwap, obv, twap,
                ad_line, ad_line_slope, ad_line_signal, cmf_20, cmf_signal,
    ...
    async def _insert_enhanced_index_data(self, table_name: str, symbol_info: SymbolInfo, indicator_results: List[IndicatorResult]) -> int:
        ...
        for result in indicator_results:
            ...
            column_mapping = {
                ...
                'adx_14': result.indicators.get('adx_14'),
                'di_plus': result.indicators.get('di_plus'),
                'di_minus': result.indicators.get('di_minus'),
                'ichimoku_tenkan_sen': result.indicators.get('ichimoku_tenkan_sen'),
                'ichimoku_kijun_sen': result.indicators.get('ichimoku_kijun_sen'),
                'ichimoku_senkou_span_a': result.indicators.get('ichimoku_senkou_span_a'),
                'ichimoku_senkou_span_b': result.indicators.get('ichimoku_senkou_span_b'),
                'ichimoku_chikou_span': result.indicators.get('ichimoku_chikou_span'),
                'ichimoku_cloud_top': result.indicators.get('ichimoku_cloud_top'),
                'ichimoku_cloud_bottom': result.indicators.get('ichimoku_cloud_bottom'),
                'ichimoku_cloud_color': result.indicators.get('ichimoku_cloud_color'),
                'ichimoku_signal': result.indicators.get('ichimoku_signal'),
                'aroon_up': result.indicators.get('aroon_up'),
                'aroon_down': result.indicators.get('aroon_down'),
                'aroon_oscillator': result.indicators.get('aroon_oscillator'),
                'aroon_signal': result.indicators.get('aroon_signal'),
